      ...
      entries => {
        entries.forEach(video => {
          if (video.isIntersecting) {
            ...
            if (video.target.hasAttribute('data-poster') && video.target.dataset.poster) {
...
// Offcanvas Cart
if (window.bootstrap) {
  document.querySelectorAll('[data-bs-toggle="offcanvas"][data-target="#offcanvas-cart"]').forEach(btn => {
  ...
  // Offcanvas Wishlist
  document.querySelectorAll('[data-bs-toggle="offcanvas"][data-target="#offcanvas-wishlist"]').forEach(btn => {
    btn.addEventListener('click', function() {
